...
class FormTemplateLibrary
{
    ...
    private function icaoDoc9303BorderMovementFields(): array
    {
        ...
        return [
            ...
            ['id' => 'origin_country', 'type' => 'select_one', 'label' => 'From Country', 'hint' => '', 'required' => false, 'options' => "sle|Sierra Leone\ngin|Guinea\nlbr|Liberia\nother|Other"],
            ['id' => 'origin_location', 'type' => 'select_one', 'label' => 'From Location', 'hint' => 'Common towns, villages, and crossing points uploaded by admins.', 'required' => false, 'option_source' => 'locations:all', 'options' => ''],
            ['id' => 'origin_location_other', 'type' => 'text', 'label' => 'From Location Other', 'hint' => 'Use when the location is not in the frequent list.', 'required' => false, 'options' => ''],
            ['id' => 'destination_country', 'type' => 'select_one', 'label' => 'To Country', 'hint' => '', 'required' => false, 'options' => "sle|Sierra Leone\ngin|Guinea\nlbr|Liberia\nother|Other"],
            ['id' => 'destination_location', 'type' => 'select_one', 'label' => 'To Location', 'hint' => 'Common towns, villages, and crossing points uploaded by admins.', 'required' => false, 'option_source' => 'locations:all', 'options' => ''],
            ['id' => 'destination_location_other', 'type' => 'text', 'label' => 'To Location Other', 'hint' => 'Use when the location is not in the frequent list.', 'required' => false, 'options' => ''],
    ...
    private function basicBorderMovementFields(): array
    {
        return [
            ...
            ['id' => 'origin_location', 'type' => 'select_one', 'label' => 'From Location', 'hint' => 'Common places uploaded by admins.', 'required' => false, 'option_source' => 'locations:all', 'options' => ''],
            ['id' => 'destination_location', 'type' => 'select_one', 'label' => 'To Location', 'hint' => 'Common places uploaded by admins.', 'required' => false, 'option_source' => 'locations:all', 'options' => ''],
            ...
            ['id' => 'nationality', 'type' => 'select_one', 'label' => 'Nationality', 'hint' => '', 'required' => true, 'options' => "sle|Sierra Leone\nlbr|Liberia\ngin|Guinea"],
        ];
    }
    ...
    private function customsGoodsDeclarationFields(): array
    {
        return [
            ...
            ['id' => 'origin_country', 'type' => 'select_one', 'label' => 'Country of Origin', 'hint' => '', 'required' => false, 'options' => "sle|Sierra Leone\ngin|Guinea\nlbr|Liberia\nother|Other"],
            ['id' => 'export_country', 'type' => 'select_one', 'label' => 'Country of Export', 'hint' => '', 'required' => false, 'options' => "sle|Sierra Leone\ngin|Guinea\nlbr|Liberia\nother|Other"],
